<?php
namespace Smile\Report\Block\Adminhtml\Post;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Smile_Report';
        $this->_controller = 'adminhtml_post';

        parent::_construct();

        if ($this->_isAllowedAction('Smile_Report::save')) {
        ...
        if ($this->_isAllowedAction('Smile_Report::post_delete')) {
