...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Smile_Report::save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Smile_Report::post')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Smile\Report\Model\Post');
